...
$mpb_semlink->setExtra("id='mpb_12_semlink1' onclick='if(this.checked){ document.getElementById(\"mpb_external1\").checked=false; document.getElementById(\"mpb_pagina1\").checked=false; document.getElementById(\"mpb_frame1\").checked=false; document.getElementById(\"mpb_external_span\").style.display=\"none\"; document.getElementById(\"mpb_35_conteudo_span\").style.display=\"none\"; document.getElementById(\"mpb_pagina_span\").style.display=\"none\"; document.getElementById(\"mpb_30_arquivo_span\").style.display=\"none\"; }else{ document.getElementById(\"mpb_35_conteudo_span\").style.display=\"\";".(($xoopsModuleConfig['mpu_conf_wysiwyg']) ? "tinyMCE.execCommand(\"mceResetDesignMode\");" : "" )."}'");
