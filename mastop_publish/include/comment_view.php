...
### www.mastop.com.br
### =============================================================
### $Id: comment_view.php,v 1.1.1.1 2007/01/31 19:30:00 topet05 Exp $
### =============================================================
...
if (XOOPS_COMMENT_APPROVENONE != $xoopsModuleConfig['com_rule']) {
	...
	$com_itemid = (trim($comment_config['itemName']) != '' && isset($_GET[$comment_config['itemName']])) ? $mpu_classe->getVar("mpb_10_id") : 0;
	if ($com_itemid > 0) {
